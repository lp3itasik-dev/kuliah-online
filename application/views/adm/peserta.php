					...
					<div class="col-xl-12">
						...
						<div class="card">
							...
							<div class="card-header pb-0">
								...
								<h5 class="card-title">Link Unduh Sertifikat : <a href="<?= base_url()?>unduh/<?= $id ?>" target="_blank"><?= base_url()?>unduh/<?= $id ?></a></h5>
								<?php if($jenis%2==0 or $jenis==3){ ?>
								    <h5 class="card-title">Link Presensi Peserta : <a href="<?= base_url()?>presensi/<?= $id ?>" target="_blank"><?= base_url()?>presensi/<?= $id ?></a></h5>
							    <?php } ?>
							</div>
							<div class="card-body">
